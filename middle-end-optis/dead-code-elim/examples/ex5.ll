...
x:
  call void @f1(i32 0, i32 2)
  br i1 %c, label %y, label %y

y:
  call void @f1(i32 0, i32 3)
  br i1 %c, label %b3, label %b4

b3:
  call void @f1(i32 0, i32 4)
  br label %b5

b4:
  call void @f1(i32 0, i32 5)
  br label %b5
...
declare dso_local void @f1(i32, i32) local_unnamed_addr #1
